...
def main(): 
    ...
    for hidden in range(6,max_hidden, 2): # only cover 6 hidden neurons for now
        ...
        for run_num in range(0,max_expruns): 
            ...
            acc_sgd = keras_nn(x_train, x_test, y_train, y_test, 0, hidden, learn_rate, run_num) #SGD with dropout
            acc_adam = keras_nn(x_train, x_test, y_train, y_test, 1, hidden, learn_rate, run_num) #Adam with dropout
            acc_adam2 = keras_nn(x_train, x_test, y_train, y_test, 2, hidden, learn_rate,  run_num) #Adam with l2
